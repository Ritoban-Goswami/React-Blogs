  ...
  return (
    <div>
      <div className="w-full max-w-2xl mx-auto">
        <h1 className="text-center text-neutral-800 dark:text-neutral-200 font-bold text-3xl my-4">
        ...
        <form onSubmit={handlSubmit} className="border rounded px-8 pt-6 pb-8">
          ...
          <div className="flex items-center justify-center">
            <button className="w-1/4 bg-transparent font-semibold text-neutral-800 dark:text-neutral-200 hover:text-green-600 py-2 px-4 border-green-600 border-2 rounded">
